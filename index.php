...
<head>
    ...
    <link rel="stylesheet" href="assets/dashboard.css?v=20260910-9">
...
<main>
    ...
    <section class="overview" aria-label="Resumen de los nodos"><div class="rewards-total"><span class="label">Rewards pendientes</span><strong id="total-rewards" aria-live="polite">—</strong><span id="total-rewards-status" class="hint">Consultando…</span></div><div class="wallets-total"><span class="label">Balance en wallets</span><strong id="total-wallets" aria-live="polite">—</strong><span id="total-wallets-status" class="hint">Consultando…</span></div><div><span class="label">API gateways</span><strong id="online">—<small> / <?php echo $directCount; ?></small></strong><span class="hint"><?php echo $directCount; ?> gateways con API</span></div><div><span class="label">TX gateways</span><strong id="sent">—</strong><span class="hint">WireGuard</span></div><div><span class="label">RX gateways</span><strong id="received">—</strong><span class="hint">WireGuard</span></div><div><span class="label">Descartados</span><strong id="dropped">—</strong><span class="hint">Gateways</span></div></section>
